...
public class KubeOperator {
    ...
    public void copy(final String filePath, final String podName, final String podLocation) throws OperatorException {
        final String command = "kubectl -n " + remote.getDirector().getNamespace() + " cp " + filePath + " " + podName + ":" + podLocation;
        executeRemote(command);
    }

    public String exec(final String podName, final String command, final int timeoutSeconds) throws OperatorException {
        final String cmd = "kubectl -n " + remote.getDirector().getNamespace() + " exec -it " + podName + " -- " + command;
